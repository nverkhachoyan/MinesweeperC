...
int isValidCell(const Game_State *game_state, const int r, const int c)
{
    if (r < 0 || c < 0)
    {
        return 0;
...
void initAdjCounts(const Game_State *game_state, const int rows, const int cols)
{
...
void shuffleCells(const Game_State *game_state, const int rows, const int cols, const int mines)
{
